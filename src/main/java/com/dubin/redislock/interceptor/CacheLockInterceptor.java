...
import com.dubin.redislock.exception.CacheLockException;
import com.dubin.redislock.redis.*;
import com.dubin.redislock.annotation.*;
...
//
//        CacheLock cacheLock = method.getAnnotations(CacheLock.class);
//        if(cacheLock == null) {
